...
const AccordionPattern = lazy(() => import("./AccordionPattern"), { ssr: false })
const HeroBannerStyle5 = lazy(() => import("./HeroBannerStyle5"), { ssr: false })
const HeroBannerStyle6 = lazy(() => import("./HeroBannerStyle6"), { ssr: false })
const TestimonyCarousel = lazy(() => import("./TestimonyCarousel"), { ssr: false })
const SpaceFourColWithFooter = lazy(() => import("./FourColFooter"), { ssr: false })
