...
import styles from './Signup.scss.lit';
...
export class Signup extends LitElement {
  ...
  /** @attr footer-link-text */
  @property({ type: String, attribute: 'footer-link-text' })
        ...
        <div class="content">
          ...
          >
            ...
            <div
              class=${classMap({
                'text-container': true,
                'text-container-split': this.splitImage,
              })}
            >
          ...
          <div class="footer">
            ...
            <space-link href=${this.signupHref}
              >${this.footerLinkText}</space-link
            >
          </div>
        </div>
        ${this.splitImage
