...
import styles from './TypeSix.scss.lit';
...
export default class TypeSix extends LitElement {
  ...
  render() {
    ...
    const boxClass = {
      'box-content': true,
      'box-content-dark': this.background,
    };
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            ${map(
              ...
              ({ location, address, phone }) => html`
                <div class="box">
                  <div class=${classMap(boxClass)}>${location}</div>
                  <div class=${classMap(boxClass)}>${address}</div>
                  <div class=${classMap(boxClass)}>${phone}</div>
                </div>
              `
            )}
