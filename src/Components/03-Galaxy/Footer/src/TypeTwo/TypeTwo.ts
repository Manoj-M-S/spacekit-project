...
import styles from './TypeTwo.scss.lit';
...
export default class FooterTypeTwo extends LitElement {
  ...
  render() {
    ...
    const lightSectionClass = {
      'section': true,
      'section-light': !this.background,
    };
    ...
    return html`
      <div class=${classMap(footerClass)}>
        ...
        <div class=${classMap(lightSectionClass)}>
          ${this.background
            ? html`<hr class=${classMap(dividerClass)} />`
            : null}
...
declare global {
  interface HTMLElementTagNameMap {
    'space-footer-type-two': FooterTypeTwo;
  }
}
