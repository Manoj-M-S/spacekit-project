...
import styles from './TypeFive.scss.lit';
...
@customElement('space-footer-type-five')
export default class TypeFive extends LitElement {
  ...
  render() {
    ...
    const headingClass = {
      'heading': true,
      'heading-dark': this.background,
    };
    const supportiveClass = {
    ...
    return html`
      <div class=${classMap(footerClass)}>
        <div class="container">
          <div class="content">
            <div class=${classMap(headingClass)}>${this.heading}</div>
            <div class=${classMap(supportiveClass)}>${this.supportiveText}</div>
          </div>
        </div>
        <div class="container nav-newsletter">
...
declare global {
  interface HTMLElementTagNameMap {
    'space-footer-type-five': TypeFive;
  }
}
