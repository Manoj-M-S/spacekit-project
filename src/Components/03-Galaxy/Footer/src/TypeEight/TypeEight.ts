...
import styles from './TypeEight.scss.lit';
...
export default class TypeEight extends LitElement {
  ...
  render() {
    ...
    const newsletterClass = {
      'newsletter': true,
      'newsletter-light': !this.background,
      'newsletter-dark': this.background,
    };

    return html`
      <div class=${classMap(newsletterClass)}>
...
declare global {
  interface HTMLElementTagNameMap {
    'space-footer-type-eight': TypeEight;
  }
}
