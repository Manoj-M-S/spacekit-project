...
import styles from './TypeEleven.scss.lit';
...
@customElement('space-footer-type-eleven')
export default class TypeEleven extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'space-footer-type-eleven': TypeEleven;
  }
}
